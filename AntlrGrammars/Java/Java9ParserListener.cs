...
public interface IJava9ParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterEmptyStatement_([NotNull] Java9Parser.EmptyStatement_Context context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="Java9Parser.emptyStatement_"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitEmptyStatement_([NotNull] Java9Parser.EmptyStatement_Context context);
	/// <summary>
